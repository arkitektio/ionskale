...
const file_ionscale_v1_derp_proto_rawDesc = "" +
	"\n" +
	"\x16ionscale/v1/derp.proto\x12\vionscale.v1\"\x1a\n" +
	"\x18GetDefaultDERPMapRequest\"1\n" +
	"\x19GetDefaultDERPMapResponse\x12\x14\n" +
	"\x05value\x18\x01 \x01(\fR\x05valueB=Z;github.com/jsiebens/ionscale/pkg/gen/ionscale/v1;ionscalev1b\x06proto3"
