...
const file_ionscale_v1_auth_keys_proto_rawDesc = "" +
	"\n" +
	"\x1bionscale/v1/auth_keys.proto\x12\vionscale.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x15ionscale/v1/ref.proto\"3\n" +
	"\x11GetAuthKeyRequest\x12\x1e\n" +
	"\vauth_key_id\x18\x01 \x01(\x04R\tauthKeyId\"E\n" +
	"\x12GetAuthKeyResponse\x12/\n" +
	"\bauth_key\x18\x01 \x01(\v2\x14.ionscale.v1.AuthKeyR\aauthKey\"\xd1\x01\n" +
	"\x14CreateAuthKeyRequest\x12\x1d\n" +
	"\n" +
	"tailnet_id\x18\x01 \x01(\x04R\ttailnetId\x12\x1c\n" +
	"\tephemeral\x18\x02 \x01(\bR\tephemeral\x126\n" +
	"\x06expiry\x18\x03 \x01(\v2\x19.google.protobuf.DurationH\x00R\x06expiry\x88\x01\x01\x12\x12\n" +
	"\x04tags\x18\x04 \x03(\tR\x04tags\x12%\n" +
	"\x0epre_authorized\x18\x05 \x01(\bR\rpreAuthorizedB\t\n" +
	"\a_expiry\"^\n" +
	"\x15CreateAuthKeyResponse\x12/\n" +
	"\bauth_key\x18\x01 \x01(\v2\x14.ionscale.v1.AuthKeyR\aauthKey\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"6\n" +
	"\x14DeleteAuthKeyRequest\x12\x1e\n" +
	"\vauth_key_id\x18\x01 \x01(\x04R\tauthKeyId\"\x17\n" +
	"\x15DeleteAuthKeyResponse\"4\n" +
	"\x13ListAuthKeysRequest\x12\x1d\n" +
	"\n" +
	"tailnet_id\x18\x01 \x01(\x04R\ttailnetId\"I\n" +
	"\x14ListAuthKeysResponse\x121\n" +
	"\tauth_keys\x18\x01 \x03(\v2\x14.ionscale.v1.AuthKeyR\bauthKeys\"\x93\x02\n" +
	"\aAuthKey\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12\x1c\n" +
	"\tephemeral\x18\x03 \x01(\bR\tephemeral\x12\x12\n" +
	...
	"\atailnet\x18\a \x01(\v2\x10.ionscale.v1.RefR\atailnetB\r\n" +
	"\v_expires_atB=Z;github.com/jsiebens/ionscale/pkg/gen/ionscale/v1;ionscalev1b\x06proto3"
