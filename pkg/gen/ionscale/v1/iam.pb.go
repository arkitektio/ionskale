...
const file_ionscale_v1_iam_proto_rawDesc = "" +
	"\n" +
	"\x15ionscale/v1/iam.proto\x12\vionscale.v1\"4\n" +
	"\x13GetIAMPolicyRequest\x12\x1d\n" +
	"\n" +
	"tailnet_id\x18\x01 \x01(\x04R\ttailnetId\".\n" +
	"\x14GetIAMPolicyResponse\x12\x16\n" +
	"\x06policy\x18\x01 \x01(\tR\x06policy\"L\n" +
	"\x13SetIAMPolicyRequest\x12\x1d\n" +
	"\n" +
	"tailnet_id\x18\x01 \x01(\x04R\ttailnetId\x12\x16\n" +
	"\x06policy\x18\x02 \x01(\tR\x06policy\"\x16\n" +
	"\x14SetIAMPolicyResponseB=Z;github.com/jsiebens/ionscale/pkg/gen/ionscale/v1;ionscalev1b\x06proto3"
